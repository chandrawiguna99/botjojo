...
//Setting ke 2
const nobot = "6281211423262"

// Setting Donasi
const gopay = "0812-1142-3262"
const ovo = "0812-1142-3262"
const dana = "0812-1142-3262"
const pulsa = "0812-1142-3262"
const pulsa2 = "0812-1142-3262"
const insta = "chndrwgnn_"
const github = "GetSya"
...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `GRUP JOJO-BOT`, url : `https://chat.whatsapp.com/` } },
			{ urlButton: { displayText: `Nomer Owner`, url : `https://wa.me/6285861009691?text=Hai+kak+aku+mau+beli+PREMIUM` } },
			{ quickReplyButton: { displayText: `💰 Donasi`, id: `${prefix}donate` } },
			{ quickReplyButton: { displayText: `Script`, id: `${prefix}sc` } },
		]
		const button5 = [
			{ callButton: { displayText: `Number Owner`, phoneNumber: `085861009691` } },
			{ urlButton: { displayText: `𝙂𝙧𝙪𝙥 𝙅𝙤𝙟𝙤`, url : `https://chat.whatsapp.com/` } },
  ...
  Note : Donasi Seikhlasnya`)
			...
			case prefix+'owner':
			    for (let x of ownerNumber) {
			      sendContact(from, x.split('@s.whatsapp.net')[0], 'ChandraWiguna', msg)
			    }
		...
		conn.sendMessage(from, {text: `Ingin bertanya tanya tentang apa?`, templateButtons: owncuy, footer: `My Name : Chandra Wiguna`, mentions: [sender]} )
			    break
case prefix+'igowner':
